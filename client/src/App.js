                  ...
                  dataList.map((el) => {
                    return (
                      <tr>
                        ...
                        <td>{el.hobby}</td>
                        <td>
                          <button onClick={() => handleEdit(el)} type="button" className="btn btn-warning mx-2">Edit</button>
                          <button onClick={() => handleDelete(el._id)} type="button" className="btn btn-danger mx-2">Delete</button>
                        </td>
                      </tr>
                    )
                  }))
